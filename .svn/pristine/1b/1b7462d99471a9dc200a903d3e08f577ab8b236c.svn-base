    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MovieDb.Models.ApplicationDbContext>
    {
        ...
        private void addActors(ApplicationDbContext context)
        {
            ...
            var actor = new List<Actor>
            {
                ...
                new Actor {Name="Gael García Bernal"},
                new Actor {Name="Luis Gnecco"},
                new Actor {Name="Mercedes Morán"},
                ...
                new Actor {Name="Renée Zellweger"},
        ...
        new Appearance
        {
...

            {
                ...
                context.Appearances.AddOrUpdate(t => t.Movie,
                    ...
                    {
                        MovieId = movie.ID,
                        ActorId = (context.Actors.First(b => b.Name == "Gael García Bernal")).ID
                    },
        new Appearance
        {
            MovieId = movie.ID,
        ...
        {
            MovieId = movie.ID,
            ActorId = (context.Actors.First(b => b.Name == "Mercedes Morán")).ID
        },
                    new Appearance
                    {
                        MovieId = movie.ID,
